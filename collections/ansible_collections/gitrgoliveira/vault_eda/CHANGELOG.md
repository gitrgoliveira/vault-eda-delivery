...
- Updated cryptography dependency from 46.0.5 to 46.0.7 for latest security fixes.
- Updated aiohttp dependency from 3.13.3 to 3.13.4 for bug fixes and improvements.
- Refreshed requirements.txt with latest compatible dependency versions.
